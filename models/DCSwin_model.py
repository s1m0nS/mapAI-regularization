...
def dcswin_base(pretrained=True, num_classes=1, weight_path='pretrain_weights/stseg_base.pth'):
...
def dcswin_small(pretrained=True, num_classes=1, weight_path='pretrain_weights/stseg_small.pth'):
...
def dcswin_tiny(pretrained=True, num_classes=1, weight_path='pretrain_weights/stseg_tiny.pth'):
    model = DCSwin(encoder_channels=(96, 192, 384, 768),
                   num_classes=num_classes,
                   embed_dim=96,
                   depths=(2, 2, 6, 2),
